...
def generate_launch_description():
    ...
    is_scout_mini_arg = DeclareLaunchArgument(
        "is_scout_mini", default_value="true", description="Scout mini model"
    )
        ...
        parameters=[
            {
                ...
                "odom_topic_name": launch.substitutions.LaunchConfiguration(
                    "odom_topic_name"
                ),
                "is_scout_mini": launch.substitutions.LaunchConfiguration(
                    "is_scout_mini"
                ),
                "is_omni_wheel": launch.substitutions.LaunchConfiguration(
                    "is_omni_wheel"
                ),
                "simulated_robot": launch.substitutions.LaunchConfiguration(
                    "simulated_robot"
                ),
