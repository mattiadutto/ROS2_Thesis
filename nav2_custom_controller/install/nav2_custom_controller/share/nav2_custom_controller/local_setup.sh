...
: ${AMENT_CURRENT_PREFIX:="/home/garabetov/turtlebot3/src/nav2_custom_controller/install/nav2_custom_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_custom_controller/environment/library_path.sh"
